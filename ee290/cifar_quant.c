...
int main (int argc, char * argv[]) {
  ...
  if (argc < 2) {
    ...
    printf("  matmul_option may be 'os', 'ws', or cpu'\n", argv[0]);
    exit(0);
  } else {
  ...
  im2col_and_matmul(
    conv_1_params.batch_size, conv_1_params.in_channels, conv_1_params.in_dim,
  ...
  pool_with_col2im(
    conv_1_params.I, conv_1_params.J,
  ...
  // conv_2   
  im2col_and_matmul(
    conv_2_params.batch_size, conv_2_params.in_channels, conv_2_params.in_dim,
  ...
  pool_with_col2im(
    ...
    conv_2_params.batch_size, conv_2_params.out_channels, 
    conv_2_params.out_dim_pooled,
